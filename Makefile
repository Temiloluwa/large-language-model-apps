...
BACKEND_VERSION := 0.0.1 # g refers to arm version
STREAMLIT_APPS_VERSION := 0.0.1
...
run:
	docker run -d -p 8501:8501 $(CI_REGISTRY_IMAGE_BACKEND)
	docker run -d -p 8100:8100 $(CI_REGISTRY_IMAGE_STREAMLIT_APPS)
